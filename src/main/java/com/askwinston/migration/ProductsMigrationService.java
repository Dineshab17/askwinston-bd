    ...
    void migrateProducts() {
        ...
        try {
            ...
            product = Product.builder()
                    ...
                    .build();
            quantities.add(new ProductQuantity(null, null, "4 pills (100mg) - $48.00", 4800L, 1, "Sildenafil 4 pills of 100 mg", ProductQuantity.Supply.DEFAULT, false, 1));
            quantities.add(new ProductQuantity(null, product, "8 pills (100mg) - $84.00", 8400L, 2, "Sildenafil 8 pills of 100 mg", ProductQuantity.Supply.DEFAULT, false, 0));
            quantities.add(new ProductQuantity(null, product, "12 pills (100mg) - $108.00", 10800L, 3, "Sildenafil 12 pills of 100 mg", ProductQuantity.Supply.DEFAULT, false, 0));
            ...
            product = Product.builder()
                    ...
                    .build();
            quantities.add(new ProductQuantity(null, null, "4 pills (20mg) - $54.00", 5400L, 1, "Tadalafil 4 pills of 20 mg", ProductQuantity.Supply.DEFAULT, false, 1));
            quantities.add(new ProductQuantity(null, null, "8 pills (20mg) - $96.00", 9600L, 2, "Tadalafil 8 pills of 20 mg", ProductQuantity.Supply.DEFAULT, false, 0));
            quantities.add(new ProductQuantity(null, null, "12 pills (20mg) - $132.00", 13200L, 3, "Tadalafil 12 pills of 20 mg", ProductQuantity.Supply.DEFAULT, false, 0));
            quantities.add(new ProductQuantity(null, null, "28 daily pills (5mg) - $100.00", 10000L, 4, "Tadalafil 28 pills of 5 mg", ProductQuantity.Supply.DEFAULT, false, 0));
            updateOrSaveProduct(product, quantities);
            quantities.clear();
