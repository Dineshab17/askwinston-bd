...
values (true, 0, false,
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="main">
                        ...
                        <br>
                        <p>If you are not ready to accept a refill, you can access your account and skip it. This can be done through the Order History page under your Account Profile. You will need to complete this before the order is processed on {orderProcessingDate}.</p>
                        <br>
        ...
        </html>', 'Remind patient about auto-refill', 'Refill soon reminder', 'Winston Auto-Refill Reminder', 3,
        true)